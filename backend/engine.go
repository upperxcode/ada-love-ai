...
func NewEngine() (*Engine, error) {
	...
	greetDBPath := filepath.Join(configDir, "greetings.db")
	var greetingSysLocal *greeting.GreetingSystem
	greetingSysLocal, err = greeting.NewGreetingSystem(greetDBPath)
	if err != nil {
