...
const setConfig: Record<string, { pkg: any; names: Record<string, string> }> = {
  modern: {
    ...
    names: {
      ...
      Network: 'LuNetwork',
      Bot: 'LuBot',
      PanelLeft: 'LuPanelLeftOpen',
      PanelLeftClose: 'LuPanelLeft',
  ...
  minimal: {
    ...
    names: {
      ...
      Sparkles: 'HiSparkles',
      Eye: 'HiEye',
      Copy: 'HiClipboardDocument',
      Bot: 'HiCommandLine',
      RefreshCw: 'HiArrowPath',
      PanelLeft: 'HiBars3CenterLeft',
      PanelLeftClose: 'HiBars3',
      Cpu: 'HiCpuChip',
      Brain: 'HiBeaker',
      Network: 'HiCube',
    },
