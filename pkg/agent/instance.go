...
import (
	...
	"ada-love-ai/pkg/isolation"
	"ada-love-ai/pkg/logger"
	"ada-love-ai/pkg/media"
	"ada-love-ai/pkg/memory"
...
func NewAgentInstance(
	...
	contextBuilder := NewContextBuilder(workspace, memStore).
		WithFolders(cfg.Agents.Defaults.Folders).
		WithPersonality(cfg.Agents.Defaults.Personality).
		WithKnowledge(cfg.Agents.Defaults.Knowledge).
