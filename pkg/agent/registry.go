...
func NewAgentRegistry(
	...
	if len(agentConfigs) == 0 {
		...
		instance := NewAgentInstance(implicitAgent, &cfg.Agents.Defaults, cfg, provider, memStore)
		...
		for i := range agentConfigs {
			...
			instance := NewAgentInstance(ac, &cfg.Agents.Defaults, cfg, provider, memStore)
