...
import (
    "ada-love-ai/pkg/bus"
    "ada-love-ai/pkg/channels"     // Reference parent package
    "ada-love-ai/pkg/config"
    "ada-love-ai/pkg/identity"      // New
    "ada-love-ai/pkg/media"          // New (if media support needed)
)
```
...
import (
    _ "ada-love-ai/pkg/channels/telegram"   // Triggers init() registration
    _ "ada-love-ai/pkg/channels/discord"
    _ "ada-love-ai/pkg/channels/your_new_channel"  // New addition
)
```
...
// cmd/picoclaw/internal/gateway/helpers.go
import (
    _ "ada-love-ai/pkg/channels/matrix"
)
```
