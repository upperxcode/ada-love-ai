...
import (
    "ada-love-ai/pkg/bus"
    "ada-love-ai/pkg/channels"     // 引用父包
    "ada-love-ai/pkg/config"
    "ada-love-ai/pkg/identity"      // 新增
    "ada-love-ai/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "ada-love-ai/pkg/channels/telegram"   // 触发 init() 注册
    _ "ada-love-ai/pkg/channels/discord"
    _ "ada-love-ai/pkg/channels/your_new_channel"  // 新增
)
```
