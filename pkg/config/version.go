...
//
//	-X ada-love-ai/pkg/config.Version=<version>
//	-X ada-love-ai/pkg/config.GitCommit=<commit>
//	-X ada-love-ai/pkg/config.BuildTime=<timestamp>
//	-X ada-love-ai/pkg/config.GoVersion=<go-version>
var (
